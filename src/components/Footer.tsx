...
export default function Footer() {
  ...
  className="relative w-full text-white rounded-[30px] mt-10 overflow-hidden"
>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 border-b border-white/10 pb-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-300 leading-relaxed max-w-xs">
          RWA Global Inc. turns physical and digital gift cards into $RWAWARD on Base.
          Fast, secure, and borderless. Redeem in seconds with no hidden fees.
        </p>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          {['Style guide', 'License', 'Changelog', 'Password Protected', '404 Error'].map(
            (item) => (
              <li key={item}>
                <Link href="#" className="hover:text-[#3EF2D0] transition">
                  {item}
      ...
      <div>
        ...
        <div className="mt-4">
          <h4 className="text-sm font-semibold text-gray-400 uppercase">Contact</h4>
