...
export default function WhoItsForSection() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] py-20 lg:py-24">
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center justify-center">
          ...
          >
            {/* Title */}
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold gradient-text leading-tight text-shadow-glow">
                Who It&apos;s For
              </h2>
            </div>
              ...
              {audiences.map((audience, index) => (
                ...
                >
                  <div className="flex flex-col space-y-2">
                    <p className="text-lg leading-relaxed text-white/80 px-6">
