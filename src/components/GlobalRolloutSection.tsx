...
export default function GlobalRolloutSection() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#0a0a0a] to-[#1a1a1a] py-12 lg:py-16">
      <motion.div
      ...
      >
        ...
        <motion.div className="text-center mb-8" variants={titleVariants}>
          <h2 className="text-4xl lg:text-5xl font-bold gradient-text leading-tight uppercase">
            Global Rollout
          </h2>
        </motion.div>
        ...
        >
          <p className="text-white/70 text-base lg:text-lg font-medium max-w-3xl mx-auto">
